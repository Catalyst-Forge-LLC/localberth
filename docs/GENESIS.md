...
Public home: `localberth.com` — a FilePress site that explains the product and how to install it. The app itself is the npm package `localberth` and runs on your machine (dashboard `:54321`). Folder: `localberth`. CLI: `localberth`.
